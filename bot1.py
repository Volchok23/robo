...
# Настройки прокси (Оставьте пустыми, если не нужен прокси)
PROXY_URL = ""  # Ваш прокси-сервер.  Если прокси не нужен, оставьте пустой строкой.

# Создаем TeleBot (без прокси, если PROXY_URL пустой)
if PROXY_URL:
    telebot.apihelper.proxy = {'https': PROXY_URL} # Добавляем прокси для telebot
...
def fetch_items():
    try:
        ...
        response = requests.get(SITE_URL, timeout=10, proxies=proxies)  # Добавлен таймаут и прокси
